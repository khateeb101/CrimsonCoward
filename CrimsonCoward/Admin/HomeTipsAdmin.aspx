<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="HomeTipsAdmin.aspx.cs" enableEventValidation="false" Inherits="CrimsonCoward.Admin.HomeTipsAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-body">
            <h1 class="Title">Home Tips List</h1>
        ...
        <div class="panel-body">
                <asp:GridView ID="HomeTipsGridView" CssClass="table table-hover table-striped" runat="server" AutoGenerateColumns="False" OnRowCommand="HomeTipsGridView_RowCommand" DataSourceID="HomeTipsObjectDataSource" > 
        <Columns>
