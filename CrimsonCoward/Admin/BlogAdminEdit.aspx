<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="BlogAdminEdit.aspx.cs" Inherits="CrimsonCoward.Admin.BlogAdminEdit" %>
        ...
        <div class="panel-body">
            ...
            <div class="row" style="margin-top:20px;">
                <div class="col-lg-6">
                    ...
                    <asp:DropDownList runat="server" ID="drpBlogCats"></asp:DropDownList>
                   <%-- <div class="form-group">
